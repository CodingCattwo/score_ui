...
<script>
import GoodsNav from '@/components/e-mall/telecom/nav/goods-nav';
export default {
  name: 'GoodsList',
  ...
  data () {
    return {
      ...
      goodsList: [
        {
          img: 'static/images/telecom/goodsList/item-show-1.jpg',
          price: 36.60,
        ...
        {
          img: 'static/images/telecom/goodsList/item-show-2.jpg',
          price: 28.00,
        ...
        {
          img: 'static/images/telecom/goodsList/item-show-3.jpg',
          price: 15.00,
        ...
        {
          img: 'static/images/telecom/goodsList/item-show-4.jpg',
          price: 29.90,
        ...
        {
          img: 'static/images/telecom/goodsList/item-show-5.jpg',
          price: 15.00,
          intro: 'BIAZE 苹果6/6s手机壳 苹果iphone6s 4.7英寸透明手机套 清爽系列',
          remarks: 6160,
          shopName: 'BIAZE官方旗舰店',
        ...
        {
          img: 'static/images/telecom/goodsList/item-show-6.jpg',
          price: 28.00,
          intro: '慕臣 苹果6s手机壳全包防摔磨砂软保护套男女 适用于iPhone6splus',
          remarks: 9006,
          shopName: '歌乐力手配专营店',
        ...
        {
          img: 'static/images/telecom/goodsList/item-show-7.jpg',
          price: 15.00,
          intro: 'BIAZE 苹果6/6s手机壳 苹果iphone6s 4.7英寸透明手机套 清爽系列',
          remarks: 8666,
          shopName: 'BIAZE官方旗舰店',
        ...
        {
          img: 'static/images/telecom/goodsList/item-show-8.jpg',
          price: 29.90,
          intro: '慕臣 苹果6s手机壳全包防摔磨砂软保护套男女 适用于iPhone6splus',
          remarks: 6080,
          shopName: '歌乐力手配专营店',
