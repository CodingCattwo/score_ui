          ...
          <Carousel autoplay loop>
              <CarouselItem>
                <router-link to="/goodsList">
                  <img :src="carouselImages.img1" class="carouselImage">
                </router-link>
              </CarouselItem>
              <CarouselItem>
                <router-link to="/goodsList">
                  <img :src="carouselImages.img2" class="carouselImage">
                </router-link>
              </CarouselItem>
          </Carousel>
        </div>
...
export default {
  ...
  data () {
    return {
      ...
      panel2: false,
      carouselImages: {
        img1: '/static/images/telecom/banner-1.jpg',
        img2: '/static/images/telecom/banner-2.jpg',
      },
      nav: [
        '秒杀',
        '优惠券',
